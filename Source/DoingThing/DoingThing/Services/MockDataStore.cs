...
namespace DoingThing.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            items = new List<Item>()
            {
				new Item { Id = Guid.NewGuid().ToString(), Text = "River Bike Path", Description= "Take a bike ride near the river."},
				...
				new Item { Id = Guid.NewGuid().ToString(), Text = "Fishing", Description="Go fishing and catch some trout down at the river canal." },
